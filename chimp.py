...
for y in range(5):
    for x in range(8):
        ...
        data_1_char = pt.image_to_string(cell, lang='eng', config='--psm 8 -c tessedit_char_whitelist=0123456789', nice=0, output_type='string', timeout=5)
        data_2_char = pt.image_to_string(cell, lang='eng', config='--psm 10 -c tessedit_char_whitelist=0123456789', nice=0, output_type='string', timeout=5)
